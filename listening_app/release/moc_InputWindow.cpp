...
static constexpr auto qt_meta_stringdata_ZN11InputWindowE = QtMocHelpers::stringData(
    "InputWindow",
    "processed",
    "",
    "handleSubmit"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11InputWindowE[] = {
...
Q_CONSTINIT const QMetaObject InputWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11InputWindowE.offsetsAndSizes,
    qt_meta_data_ZN11InputWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11InputWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void InputWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (InputWindow::*)();
            if (_q_method_type _q_method = &InputWindow::processed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *InputWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11InputWindowE.stringdata0))
